...
export default function App() {
  ...
  const {
    handleSubmit, getData, register, registerError, registerButton, reset
  } = useForm();

  return (
    <>
      <form onSubmit={handleSubmit(() => setSuccessMsg(JSON.stringify(getData())))}>
        <p>
          Full name: <input {...register('full_name', { required: true })} autoFocus />
        </p>
